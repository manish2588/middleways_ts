  ...
  return (
    <div>
      <div className="flex justify-center mt-24 mb-8">
        <h2 className="mb-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white mt-8">
          Who We Are
        </h2>
      </div>
      <div className="w-full md:w-3/4 lg:w-2/3 mx-auto p-4 rounded-lg mt-4">
        <p
          className="mb-3 font-openSans font-light text-xl text-gray-950 dark:text-gray-400"
          style={{ textAlign: "justify" }}
        >
          Established in 2007 in the heart of Nepal, Kathmandu Films has been a
          trusted partner for all filming needs in the region. Founded by
          Chandan Jha, renowned as the best fixer and line producer in Nepal, we
          boast a dedicated team of Asia’s finest crew members and a proficient
          logistics team. Equipped to tackle any challenge, our shared passion
          for filmmaking and industry professionalism drives us to deliver
          unparalleled results. Our client-centric approach ensures diverse
          service options tailored to your needs. Embark on your filming journey
          in Nepal with us and experience the dedication of our young, creative
          team. From script to screen, we go to great lengths to craft perfect
          frames for you. Work with Kathmandu Films for a seamless and
          professional filming experience in the captivating landscapes of
          Nepal. Start your project with us and witness your vision come to
          life!
        </p>
      </div>
      ...
      <div className="w-full md:w-3/4 lg:w-2/3 mx-auto p-4 rounded-lg mt-4">
        <p
          className="mb-3 font-light font-openSans text-xl text-gray-950 dark:text-gray-400"
          style={{ textAlign: "justify" }}
        >
          We are a group of professionals committed to innovative processes that
          promote continuous learning and raise the bar for organizational and
          individual results.
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center bg-white p-6">
        {teamMembers.map((member) => (
          <div
            key={member.id}
            className="relative p-4 bg-white flex flex-col items-center"
          >
            ...
            <div className="text-center mt-4 w-96">
              <h2 className="text-xl font-semibold font-openSans">
                {member.name}
              </h2>
